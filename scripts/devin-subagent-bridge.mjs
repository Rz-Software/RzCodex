...
const OPENCODE_REQUIRED_EFFORT = "max";
...
function managedModelsResponse() {
  ...
  const modelDefinition = (slug, displayName, description, contextWindow, effort, mainAgent = false) => ({
    ...
    upgrade: null, include_skills_usage_instructions: false, include_plugin_usage_instructions: mainAgent,
    include_apps_usage_instructions: mainAgent, supports_reasoning_summary_parameter: false, default_reasoning_summary: "none",
