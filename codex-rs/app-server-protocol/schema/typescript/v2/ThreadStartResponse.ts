...
export type ThreadStartResponse = {thread: Thread, model: string, modelProvider: string, modelInputModalities?: Array<InputModality>, serviceTier: string | null, cwd: AbsolutePathBuf, /**
